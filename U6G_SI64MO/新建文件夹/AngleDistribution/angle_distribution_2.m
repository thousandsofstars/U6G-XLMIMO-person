...
figure()
plot(APAP(:,1),APAP_nor);xlim([20 160]);
...
title('Gauss fitting');xlabel('AoA(°)');ylabel('Power,P(dB)');xlim([20 160]);
...
title('VonMises fitting');xlabel('AoA(°)');ylabel('Power,P(dB)');xlim([20 160]);
